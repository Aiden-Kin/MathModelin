...
# 使用修改后的阻尼力方程来为恒定阻尼进行优化
modified_result_constant_damping = minimize_scalar(modified_average_power_constant_damping, bounds=(0, 100000), method='bounded')
modified_optimal_constant_damping = modified_result_constant_damping.x
modified_max_avg_power_constant_damping = -modified_result_constant_damping.fun

print("最优阻尼常数:", modified_optimal_constant_damping)
print("最大平均功率输出:", modified_max_avg_power_constant_damping)
